...
int main(int argc, char * argv[])
{
  ...
  action_client = rclcpp_action::create_client<control_msgs::action::FollowJointTrajectory>(
    ...
    "/my_rotate_bot_controller/follow_joint_trajectory");
  ...
  std::vector<std::string> joint_names = {"link_1_JOINT_0"};
  ...
  // revolute joints expect radians (vs meters in original gazebo_ros2_control_demo code)
  point2.positions[0] = -1.0472;

  trajectory_msgs::msg::JointTrajectoryPoint point3;
  point3.time_from_start = rclcpp::Duration::from_seconds(2.0);
  point3.positions.resize(joint_names.size());
  point3.positions[0] = 1.0472;
